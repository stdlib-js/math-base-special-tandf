...
var tandf = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( tandf instanceof Error )
};
...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof tandf, 'function', 'main export is a function' );
	t.end();
});
